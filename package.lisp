...
(defpackage :srfi-19
  ...
  (:export
   ...
   :time-resolution :make-time :time? :time-type :time-nanosecond :time-second
   :set-time-type! :set-time-nanosecond! :set-time-second! :copy-time :time<=?
   :time<? :time=? :time>? :time>=? :time-difference :time-difference!
   :add-duration :add-duration! :subtract-duration :subtract-duration! :make-date
   ...
   :time-utc->time-tai! :date->string :string->date))

(defpackage :srfi-19.internal
  (:use :srfi-19 :cl :fiveam
        :srfi-9 :srfi-8 :srfi-6
        :mbe)
